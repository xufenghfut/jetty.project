...
public class AsyncServletTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        ServletHolder error = new ServletHolder(new TestServlet());
        error.setName("Error");
        error.setAsyncSupported(true);
        _servletHandler.addServletWithMapping(error, "/error/*");
        ...
        ServletHolder forward = new ServletHolder(new FwdServlet());
        forward.setName("Forward");
        _servletHandler.addServletWithMapping(forward, "/fwd/*");

        ServletHolder noAsync = new ServletHolder("NoAsync", _servlet);
        noAsync.setAsyncSupported(false);
        _servletHandler.addServletWithMapping(noAsync, "/noasync/*");
    ...
    public void testSleep() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?sleep=200",
            "initial"));
    ...
    public void testAsyncNotSupportedNoAsync() throws Exception
    {
        ...
        assertThat(response, Matchers.startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST NoAsync /ctx/noasync/info",
            "initial"
        ));
    ...
    public void testAsyncNotSupportedAsync() throws Exception
    {
        try (StacklessLogging stackless = new StacklessLogging(HttpChannel.class))
        {
            ...
            assertThat(__history, contains(
                "REQUEST NoAsync /ctx/noasync/info?start=200",
                "initial",
                "ERROR Error /ctx/error/custom?start=200",
                "!initial"
            ));

            assertContains("500", response);
            assertContains("!asyncSupported", response);
            assertContains("AsyncServletTest$TestServlet", response);
        }
    }
    ...
    public void testStart() throws Exception
    {
        ...
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200",
            "initial",
            "start",
            "onTimeout",
            "ERROR Error /ctx/error/custom?start=200",
    ...
    public void testStartOnTimeoutDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&timeout=dispatch",
            "initial",
            "start",
            "onTimeout",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=200&timeout=dispatch",
            "!initial",
            "onComplete"));
    ...
    public void testStartOnTimeoutError() throws Exception
    {
        ...
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&timeout=error",
            "initial",
            "start",
            "onTimeout",
            "error",
            "ERROR Error /ctx/error/custom?start=200&timeout=error",
            "!initial",
            "onComplete"));
    ...
    public void testStartOnTimeoutComplete() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&timeout=complete",
            "initial",
            "start",
            "onTimeout",
            "complete",
    ...
    public void testStartWaitDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&dispatch=10",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=200&dispatch=10",
            "!initial",
            "onComplete"));
        assertFalse(__history.contains("onTimeout"));
    }
    ...
    public void testStartDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&dispatch=0",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=200&dispatch=0",
            "!initial",
            "onComplete"));
    }
    ...
    public void testStartError() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 500 Server Error"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&throw=1",
            "initial",
            "start",
            "onError",
            "ERROR Error /ctx/error/custom?start=200&throw=1",
            "!initial",
            "onComplete"));
        assertContains("ERROR DISPATCH: /ctx/error/custom", response);
    }
    ...
    public void testStartWaitComplete() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&complete=50",
            "initial",
            "start",
            "complete",
            "onComplete"));
    ...
    public void testStartComplete() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&complete=0",
            "initial",
            "start",
            "complete",
            "onComplete"));
    ...
    public void testStartWaitDispatchStartWaitDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=1000&dispatch=10&start2=1000&dispatch2=10",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=1000&dispatch=10&start2=1000&dispatch2=10",
            "!initial",
            "onStartAsync",
            "start",
            "dispatch",
    ...
    public void testStartWaitDispatchStartComplete() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=1000&dispatch=10&start2=1000&complete2=10",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=1000&dispatch=10&start2=1000&complete2=10",
            "!initial",
            "onStartAsync",
            "start",
            "complete",
    ...
    public void testStartWaitDispatchStart() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 500 Server Error"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=1000&dispatch=10&start2=10",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?start=1000&dispatch=10&start2=10",
            "!initial",
            "onStartAsync",
            "start",
            "onTimeout",
            "ERROR Error /ctx/error/custom?start=1000&dispatch=10&start2=10",
            "!initial",
            "onComplete"));
        assertContains("ERROR DISPATCH: /ctx/error/custom", response);
    }
    ...
    public void testStartTimeoutStartDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=10&start2=1000&dispatch2=10",
            "initial",
            "start",
            "onTimeout",
            "ERROR Error /ctx/error/custom?start=10&start2=1000&dispatch2=10",
            "!initial",
            "onStartAsync",
            "start",
            "dispatch",
            "ASYNC Error /ctx/path/info?start=10&start2=1000&dispatch2=10",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    }
    ...
    public void testStartTimeoutStartComplete() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=10&start2=1000&complete2=10",
            "initial",
            "start",
            "onTimeout",
            "ERROR Error /ctx/error/custom?start=10&start2=1000&complete2=10",
            "!initial",
            "onStartAsync",
            "start",
            "complete",
    ...
    public void testStartTimeoutStart() throws Exception
    {
        ...
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=10&start2=10",
            "initial",
            "start",
            "onTimeout",
            "ERROR Test /ctx/path/error?start=10&start2=10",
            "!initial",
            "onStartAsync",
            "start",
            "onTimeout",
    ...
    public void testWrapStartDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?wrap=true&start=200&dispatch=20",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path/info?wrap=true&start=200&dispatch=20",
            "wrapped REQ RSP",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    ...
    public void testStartDispatchEncodedPath() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "REQUEST Test /ctx/path/info?start=200&dispatch=20&path=/p%20th3",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/p%20th3?start=200&dispatch=20&path=/p%20th3",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    }
    ...
    public void testFwdStartDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "FWD REQUEST Forward /ctx/fwd/info?start=200&dispatch=20",
            "FORWARD Test /ctx/path1?forward=true",
            "initial",
            "start",
            "dispatch",
            "FWD ASYNC Test /ctx/fwd/info?start=200&dispatch=20",
            "FORWARD Test /ctx/path1?forward=true",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    ...
    public void testFwdStartDispatchPath() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "FWD REQUEST Forward /ctx/fwd/info?start=200&dispatch=20&path=/path2",
            "FORWARD Test /ctx/path1?forward=true",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path2?start=200&dispatch=20&path=/path2",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    }
    ...
    public void testFwdWrapStartDispatch() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "FWD REQUEST Forward /ctx/fwd/info?wrap=true&start=200&dispatch=20",
            "FORWARD Test /ctx/path1?forward=true",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path1?forward=true",
            "wrapped REQ RSP",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    ...
    public void testFwdWrapStartDispatchPath() throws Exception
    {
        ...
        assertThat(response, startsWith("HTTP/1.1 200 OK"));
        assertThat(__history, contains(
            "FWD REQUEST Forward /ctx/fwd/info?wrap=true&start=200&dispatch=20&path=/path2",
            "FORWARD Test /ctx/path1?forward=true",
            "initial",
            "start",
            "dispatch",
            "ASYNC Test /ctx/path2?forward=true",
            "wrapped REQ RSP",
            "!initial",
            "onComplete"));
        assertContains("DISPATCHED", response);
    ...
    public void testAsyncRead() throws Exception
    {
        ...
        try (Socket socket = new Socket("localhost", _port))
        {
            ...
            assertThat(response, startsWith("HTTP/1.1 200 OK"));
            assertThat(__history, contains(
                "REQUEST Test /ctx/path/info?start=2000&dispatch=1500",
                "initial",
                "start",
                "async-read=10",
                "dispatch",
                "ASYNC Test /ctx/path/info?start=2000&dispatch=1500",
                "!initial",
                "onComplete"));
        }
    }
    ...
    private static class FwdServlet extends HttpServlet
    {
        ...
        public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException
        {
            historyAdd("FWD " +
                ...
                " " + URIUtil.addPathQuery(request.getRequestURI(), request.getQueryString()));
    ...
    private static class TestServlet extends HttpServlet
    {
        ...
        public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException
        {
            ...
            historyAdd(request.getDispatcherType() +
                " " +
                request.getHttpServletMapping().getServletName() +
                " " +
                URIUtil.addPathQuery(request.getRequestURI(), request.getQueryString()));
